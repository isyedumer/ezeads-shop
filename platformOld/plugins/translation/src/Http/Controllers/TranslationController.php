...
class TranslationController extends BaseController
{
    ...
    public function getThemeTranslations(Request $request, TableBuilder $tableBuilder)
    {
        ...
        /**
         * @var ThemeTranslationTable $translationTable
         */
        $translationTable = $tableBuilder->create(ThemeTranslationTable::class);
