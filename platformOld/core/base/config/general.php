...
return [
    ...
    'purifier' => [
        'default' => [
            ...
            'URI.SafeIframeRegexp' => env('CMS_IFRAME_FILTER_URL_REGEX', '%^(http://|https://|//)(' . env('CMS_IFRAME_ALLOWED_URLS', 'www.youtube.com/embed/|player.vimeo.com/video/|map.google.com/maps/') . ')%'),
