...
<head>
    ...
    <meta name="keywords" property="keywords"
        content="auction, auctions, classified, classifieds, canadian, canadian, auctions, classifieds, events calendar, fraud gallery, report fraud, business directory, jobs, personals, services wanted, residential rentals, commercial rentals, charity auctions, featured gallery">
...
<body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif
    ...
    <header class="header header-js-handler"
        ...
        <div class="header-middle shadow">
                                ...
                                @if (auth('customer')->check())
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu p-2" aria-labelledby="dropdownMenuButton">
                                            {{-- <li>
                                                <a href="https://www.ezead.com/" class="dropdown-item"
                                                    target="_blank">
                                            ...
                                            <li>
                                                <a href="{{ route('customer.edit-account') }}" class="dropdown-item">
                                            ...
                                            <li>
                                                <a href="{{ route('customer.address') }}" class="dropdown-item">
                                                    <i class="fas fa-address-card"></i>
                                                    Addresses
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('customer.overview') }}" class="dropdown-item">
                        ...
                        <div class="container-fluid">
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item">
                                        <a href="//community.ezead.com" class="nav-link" aria-current="page"
                                            target="_blank">
                                            <div class="main-category-wrapper" style="display: grid;">
                                                <span class="cat_icon text-center" style="font-size: 24px">
                                ...
                                <div class="col-12 px-5 py-3 rounded" style="background-color: whitesmoke;">
                                    <div class="row gx-1 gy-1">
                                        <div class="col-xl-6 col-md-6 col-sm-12 col-12 px-2">
                                            <span style="color:#777777;position: absolute;padding: 12px 0px 10px 28px;">
                                                <i class="fas fa-globe"></i>
                                            </span>
                                            <input
